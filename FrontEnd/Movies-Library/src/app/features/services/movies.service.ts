...
export class MoviesService {
  ...
  public getUserMovies(id: any, page:any = 1): Observable<any> {
    ...
    return this.http.get<Array<AggregatedMovieModel>>(`${this.endpoint}users/${id}/movies?page=${page}`, this.httpOptions).pipe(
